...
public class DataUtil {
	...
	public String actuatorDataToTimeAndValueJson(ActuatorData data) {
		...
		if (data != null) {
			TimeAndValuePayloadData tvData =
				new TimeAndValuePayloadData(data);
	...
	public TimeAndValuePayloadData jsonToTimeAndValuePayloadData(String jsonData)
	{
		TimeAndValuePayloadData data = null;

		if (jsonData != null && jsonData.trim().length() > 0) {
			data = this.gson.fromJson(
				jsonData,
				TimeAndValuePayloadData.class);
		}
